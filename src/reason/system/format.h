...
public:
	...
	struct Specifier : public Bitmask64
	{
		...
		Specifier(int options):Bitmask64(options),Width(0),Precision(0) {}
	};

	struct Value : public Bitmask32
	{
		enum ValueTypes
		{
			TYPE_NUMBER		=(1)<<0,
		...
		Reason::System::Number Number;
		void * Pointer;

		Value & operator = (int mask) {Bitmask32::operator =(mask);return *this;}
	};

	struct Argument : public Bitmask32
	{
		...
		struct ArgumentKind
		{
			...
			ArgumentKind(Reason::System::String & value, void * pointer):Value(),String(value),Pointer(pointer) {}
		...
		Argument():Kind() {}
		Argument(int options, char value, void * pointer=0):Bitmask32(options),Kind(value,pointer) {}
		Argument(int options, int value, void * pointer=0):Bitmask32(options),Kind(value,pointer) {}
		Argument(int options, long value, void * pointer=0):Bitmask32(options),Kind(value,pointer) {}
		Argument(int options, long long value, void * pointer=0):Bitmask32(options),Kind(value,pointer) {}
		Argument(int options, double value, void * pointer=0):Bitmask32(options),Kind(value,pointer) {}
		Argument(int options, char * value, void * pointer=0):Bitmask32(options),Kind(value,pointer) {}
		Argument(int options, int * value, void * pointer=0):Bitmask32(options),Kind((void*)value,pointer) {}
		Argument(int options, long * value, void * pointer=0):Bitmask32(options),Kind((void*)value,pointer) {}
		Argument(int options, void * value, void * pointer=0):Bitmask32(options),Kind((void*)value,pointer) {}
	...
	int Mode;
	Reason::Structure::Array<Specifier> Specifiers;
	...
	void Construct(Sequence & sequence, int mode) {Construct(sequence.Data,sequence.Size,mode);}
...
class FormattingStream : public Reason::System::Formatting, public Reason::System::StreamFilter
{
public:

	int Index;

	Reason::System::Token Token;
...
public:
	...
	Reason::System::FormattingStream Formatting;
	int Index;

	Format(const char * format):Formatting(format,0),Index(0)
	{
	}
